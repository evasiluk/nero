...
<table class="equipment ordersmore" style="width:726px">
	<thead>
		<tr>
			<td colspan="2"><?=GetMessage("SPOD_ORDER_NO")?>&nbsp;<?=$arResult["ACCOUNT_NUMBER"]?>&nbsp;<?=GetMessage("SPOD_FROM")?> <?=$arResult["DATE_INSERT"] ?></td>
		</tr>
	</thread>
	...
	<?endif;?>
		...
		?>
		<tr>
			<td><strong><?=GetMessage("P_ORDER_TRACKING_NUMBER")?>:</strong></td>

...
<form action="<?= $arResult["FORM_ACTION"] ?>" method="get">
    <div class="table-auto add-compact">
        <table class="tbl">
            <thead>
            <tr>
                <td colspan="3"><? echo GetMessage("subscr_title_status") ?></td>
            </tr>
            </thead>
            <tr valign="top">
                <td nowrap><? echo GetMessage("subscr_conf") ?></td>
                <td nowrap
                    class="<? echo($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y" ? "notetext" : "errortext") ?>"><? echo($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y" ? GetMessage("subscr_yes") : GetMessage("subscr_no")); ?></td>
            ...
            <tr>
                ...
                <td nowrap
                    class="<? echo($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y" ? "notetext" : "errortext") ?>"><? echo($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y" ? GetMessage("subscr_yes") : GetMessage("subscr_no")); ?></td>
            </tr>
            <tr>
                ...
                <tr>
                    <td colspan="3">
                        <? if ($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"): ?>
                            <input class="btn-default" type="submit" name="unsubscribe" value="<? echo GetMessage("subscr_unsubscr") ?>"/>
                            <input type="hidden" name="action" value="unsubscribe"/>
                        <? else: ?>
                            <input class="btn-default" type="submit" name="activate" value="<? echo GetMessage("subscr_activate") ?>"/>
